class Workouts::ExerciseWorkoutsController < Workouts::ApplicationController
  ...
  private
    ...
    def exercise_workout_params
      params.require(:exercise_workout).permit(:exercise_id, :workout_id, :serie_type, :serie_rest, :notes, exercise_series_attributes: [:id, :reps, :weight, :time_track, :_destroy])
    end
end
